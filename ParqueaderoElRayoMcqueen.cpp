...
<<<<<<< HEAD
	do{	
		...
		try{
			...
			mosCen( "La entrada no es v醠ida. Debe ingresar un valor entero\n");
=======
	do{
...
void salida(){
	...
	mosCen("--------------------------------------------- Salida ---------------------------------------------\n");
	cout<<endl;
	mosCen("Ingrese por favor su n鷐ero de identificaci髇 (sin espacios ni puntos)\n");
	cout<<endl;
=======
...
>>>>>>> af9be925280435b5c6a4b4fb8c3fc7d71a9f7d33
	...
	cout<<endl;
	cout<<endl;
	cout<<"Ser vivo "<<nombre<<" espero que tenga un d韆 maravilloso\n";
	cout<<endl;
	system("pause");
}
//Funcion que pide los datos del cliente
...
<<<<<<< HEAD
	...
	cout<<endl;
	mosCen("(1)Autom髒il, campero, camioneta y veh韈ulo pesado\n");
	cout<<endl;
...
>>>>>>> af9be925280435b5c6a4b4fb8c3fc7d71a9f7d33
	...
	archivo.close();
	mosCen("Desea dejar su vehiculo por m醩 de 12 horas en nuestro gran parqueadero\n");
	cout<<endl;
	mosCen("(1)Si \t(2)No\n");
	int opc7;
	cout<<endl;
	...
	if(opc7==1){
		...
		cout<<endl;
		cout<<endl;
		cout<<"Ser vivo "<<cli.nombrecompleto<<" espero que tenga un d韆 maravilloso\n";
		cout<<endl;
		system("pause");
	}else{
		return;
